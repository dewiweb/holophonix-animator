...
describe('Animation-Track Integration', () => {
  ...
  it('should highlight track when its animation is playing', () => {
  ...
  it('should update track position based on circular animation', () => {
  ...
  it('should show animation preview in track list', () => {
    const mockCircularAnimation: CircularAnimation = {
      id: 'anim2',
      type: 'circular',
      name: 'Circular Test',
