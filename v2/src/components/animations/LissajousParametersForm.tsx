  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Frequency Ratio A</label>
          <input
            type="number"
            min="1"
            step="1"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Frequency Ratio B</label>
          <input
            type="number"
            min="1"
            step="1"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Phase Difference (°)</label>
        <input
          type="number"
          min="0"
          max="360"
