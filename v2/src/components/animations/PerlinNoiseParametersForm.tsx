...
export const PerlinNoiseParametersForm: React.FC<PerlinNoiseParametersFormProps> = ({ parameters, onParameterChange }) => {
  return (
    <div className="space-y-4">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Bounds (Movement Area)</label>
        <div className="grid grid-cols-3 gap-2">
          <input
            type="number"
            min="0.1"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Frequency</label>
          <input
            type="number"
            min="0.1"
            step="0.1"
          ...
          />
          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Higher = faster movement</p>
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Scale</label>
          <input
            type="number"
            min="0.1"
            step="0.1"
            ...
            className="w-full px-2 py-1 border border-gray-200 dark:border-gray-600 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
          />
          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Multiplier for movement</p>
        </div>
      </div>

      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Octaves (Detail)</label>
          <input
            type="number"
            min="1"
            max="8"
            ...
            className="w-full px-2 py-1 border border-gray-200 dark:border-gray-600 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
          />
          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">More = more detail (slower)</p>
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Persistence</label>
          <input
            type="number"
            min="0"
            max="1"
            ...
            className="w-full px-2 py-1 border border-gray-200 dark:border-gray-600 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
          />
          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Roughness vs smoothness</p>
        </div>
      </div>

      <div>
        <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Random Seed</label>
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-2 py-1 border border-gray-200 dark:border-gray-600 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
          />
          <button
        ...
        <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Change for different patterns</p>
      </div>
