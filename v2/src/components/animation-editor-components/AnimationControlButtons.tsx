  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      <button
        onClick={onStop}
        disabled={!hasAnimation}
        className="px-3 py-2 bg-red-600 text-white rounded-md text-sm hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
      >
      ...
      {isCustomAnimation && (
        <button
          ...
          className={cn(
            "px-3 py-2 rounded-md text-sm transition-colors flex items-center",
            showKeyframeEditor ? "bg-purple-600 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"
          )}
        >
      ...
      <button
        ...
        className="px-3 py-2 bg-green-600 text-white rounded-md text-sm hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
      >
